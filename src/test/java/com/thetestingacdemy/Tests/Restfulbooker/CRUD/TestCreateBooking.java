...
public class TestCreateBooking extends BaseTest {
    ...
    public void testCreateBookingPOST_Positive(){
        ...
        //Validation & Verification Via the AssertJ & TestNG Part -3
        assertActions.verifyStatusCode(response,200);
        assertActions.verifyStringKeyNotNull(bookingResponse.getBookingid());
        assertActions.verifyStringKey(bookingResponse.getBooking().getFirstname(),"Aishwarya");
    }
    ...
    @Test(groups = "reg", priority =1)
    @Owner("Aishwarya")
    @Description("TC#1 - Verify that the Booking can't be created, When payload is RANDOM")
